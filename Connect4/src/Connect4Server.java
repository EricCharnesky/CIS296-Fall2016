...
public class Connect4Server extends Application 
  ...
  class HandleASession implements Runnable, Connect4Constants {
    ...
    private char[][] cell =  new char[BOARD_ROWS][BOARD_COLUMNS];
    ...
    private boolean isWon(char token) {
    	...
    	// check columns for 4 in a row of my token
    	for (int column = 0; column < BOARD_COLUMNS; column++ )
    	{
    		for ( int row = 0; row < 3; row++ )
    		{
    			if ( cell[row][column] == token 
					&& cell[row+1][column] == token 
					&& cell[row+2][column] == token 
					&& cell[row+3][column] == token )
    			{
    				return true;
    			}
    		}
    	...
    	// check rows for 4 in a row of my token
    	for (int row = 0; row < BOARD_ROWS; row++ )
    	{
    		for ( int column = 0; column < 4; column++ )
    		{
    			if ( cell[row][column] == token 
    					&& cell[row][column+1] == token 
    					&& cell[row][column+2] == token 
    					&& cell[row][column+3] == token )
    			{
    				return true;
    			}
    		}
    	...
    	for ( int row = 0; row < 3; row++ )
    	{
    		...
    		{
    			if ( cell[row][column] == token 
    					&& cell[row+1][column+1] == token 
    					&& cell[row+2][column+2] == token 
    					&& cell[row+3][column+3] == token )
    			{
    				return true;
    			}
    		}
